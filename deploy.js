...
function createRemoteTempFolder() {
  return ssh.execCommand(
    'rm -rf riot-express-todo-list-master && mkdir riot-express-todo-list-master', {
      cwd: '/home/ubuntu'
  });
}
...
function updateRemoteApp() {
  return ssh.execCommand(
    'mkdir riot-express-todo-list-master && cp -r riot-express-todo-list-master/* riot-express-todo-list-master/ && rm -rf riot-express-todo-list-master', {
      cwd: '/home/ubuntu'
  });
}
